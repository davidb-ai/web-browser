#!/usr/bin/env python3
"""
String replacement module for zalk-os build system
"""
...
branding_replacements = [
    (
        ...
        r"The zalk-os Authors. All rights reserved.",
    ),
    (
        r"Google LLC. All rights reserved.",
        r"The zalk-os Authors. All rights reserved.",
    ),
    (r"The Chromium Authors", r"zalk-os Software Inc"),
    (r"Google Chrome", r"zalk-os"),
    (r"(Google)(?! Play)", r"zalk-os"),
    (r"Chromium", r"zalk-os"),
    (r"Chrome", r"zalk-os"),
]
